...
class ForumThreadsControllerTest < ActionController::TestCase
  ...
  test "should create forum_thread" do
    assert_difference('ForumThread.count') do
      post :create, forum_thread: { content: @forum_thread.content, sticky_order: @forum_thread.sticky_order, title: @forum_thread.title, user_id: @forum_thread.user_id }
    end
  ...
  test "should update forum_thread" do
    patch :update, id: @forum_thread, forum_thread: { content: @forum_thread.content, sticky_order: @forum_thread.sticky_order, title: @forum_thread.title, user_id: @forum_thread.user_id }
    assert_redirected_to forum_thread_path(assigns(:forum_thread))
  end
